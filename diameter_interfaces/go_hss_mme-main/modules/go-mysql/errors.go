...
var (
	...
	ErrOldPassword       = errors.New("this user requires old password authentication. If you still want to use it, please add 'allowOldPasswords=1' to your DSN. See also https://epiphanyHSS/modules/go-mysql/wiki/old_passwords")
	...
	// See https://epiphanyHSS/modules/go-mysql/pull/302
